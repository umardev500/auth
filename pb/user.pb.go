...
func (x *UserLoginResponse) GetIsExist() bool {
	if x != nil {
		return x.IsExist
	}
	return false
...
var file_pb_user_proto_rawDesc = []byte{
	...
	0x3a, 0x0a, 0x10, 0x55, 0x73, 0x65, 0x72, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x52, 0x65, 0x71, 0x75,
	...
	0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x70, 0x61, 0x73, 0x73, 0x22, 0x2e, 0x0a, 0x11, 0x55,
	...
	0x28, 0x08, 0x52, 0x07, 0x69, 0x73, 0x45, 0x78, 0x69, 0x73, 0x74, 0x32, 0x3f, 0x0a, 0x0b, 0x55,
...
var file_pb_user_proto_depIdxs = []int32{
	0, // 0: UserService.Login:input_type -> UserLoginRequest
	1, // 1: UserService.Login:output_type -> UserLoginResponse
